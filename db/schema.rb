...
ActiveRecord::Schema[7.1].define(version: 2024_08_26_160037) do
  ...
  create_table "footprints", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["transport_id"], name: "index_footprints_on_transport_id"
  ...
  add_foreign_key "footprints", "transports"
